...
namespace PF.Dojo.StorageProviders.MongoDb
{
	public class MongoDbStorageProvider : IStorageProvider
	{
		...
		public async Task ReadStateAsync(string grainType, GrainReference grainReference, IGrainState grainState)
		{
			...
			var key = UseGuidAsStorageKey
				? grainReference.GetPrimaryKey(out extendKey).ToString()
		...
		{
			//review
			var data = JsonConvert.DeserializeObject(entityData, grainState.GetType(),
				GrainStateMongoDataManager.JsonSetting);
